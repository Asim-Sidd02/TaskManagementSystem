			...
			<table class="table tabe-hover table-condensed" id="list">
				...
				<tbody>
					...
					<tr>
						...
						<?php
					  echo '<a href="' . $row['link'] . '" target="blank" class="btn btn-sm btn-primary">Read</a>';
					  ?>
					  </th>
						...
						<td class="text-center">
		                    ...
		                    <div class="dropdown-menu" style="">
							  ...
							  <a class="dropdown-item view_project" href="./index.php?page=view_project&id=<?php echo $row['id'] ?>" data-id="<?php echo $row['id'] ?>">Status</a>
		                      <div class="dropdown-divider"></div>
		                      <?php if($_SESSION['login_type'] != 3): ?>
